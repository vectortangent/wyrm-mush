...
This game uses the WOD20 system, Third Edition.  The complete guide can be found online: [WOD20 Player's Guide](http://www.aresmush.com/wod20/wod20-3).
...
WOD20 has several basic types of abilities:
...
> **Tip:** See the [Chargen](https://aresmush.com/wod20/wod20-3/chargen.html) section of the player's guide for details about the ratings, costs, and how to choose abilities.
...
> **Tip:** See the [Conflict](https://aresmush.com/wod20/wod20-3/conflict.html) section of the player's guide for details about when and how to use ability rolls to resolve conflicts.

The basic roll mechanic in WOD20 is to roll a number of dice equal to Attribute + Ability, and count successes.  One success is enough to accomplish the task at hand; more successes mean you do better than expected.

    <WOD20> Hannah rolls Firearms: Good Success (7 7 7 4)
...
You can also do opposed rolls, which basically just compare the number of successes from each side and figure out who won and by how much.
    ...
    <WOD20> Flare rolls Firearms (8 4 3 2 1) vs Ivan's Firearms (8 7 6 6 6 5 5 2 1 1)
    <WOD20>          Crushing Victory for Ivan.
...
Luck Points in WOD20 can be used to generate various lucky breaks.  Luck points are earned by participating in scenes. You can use luck points for combat, ability rolls, or other plot points at the storyteller's discretion.

> **Tip:** See the [Luck](https://aresmush.com/wod20/wod20-3/luck.html) section of the player's guide for details about when and how to use luck points.
...
> **Tip:** See the [Experience](https://aresmush.com/wod20/wod20-3/experience.html) section of the player's guide for details about how to use experience points.
...
The WOD20 System Copyright 2007 by Wordsmyth Creations LLC and is licensed under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International License (http://creativecommons.org/licenses/by-nc-sa/4.0/).