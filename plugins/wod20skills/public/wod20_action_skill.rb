module AresMUSH
  class WOD20ActionSkill < Ohm::Model
    include ObjectModel
    ...
    def rating_name
      case rating
      when 0
        return t('wod20skills.incapable_rating')
      when 1
        return t('wod20skills.everyman_rating')
      when 2
        return t('wod20skills.fair_rating')
      when 3
        return t('wod20skills.competent_rating')
      when 4
        return t('wod20skills.good_rating')
      when 5
        return t('wod20skills.great_rating')
      when 6
        return t('wod20skills.exceptional_rating')
      when 7
        return t('wod20skills.amazing_rating')
      when 8
        return t('wod20skills.legendary_rating')
      end
    end
  end
end
