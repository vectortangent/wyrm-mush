    ...
    class OpposedRollCmd
      ...
      def handle
        ...
        if (!model1 && !self.roll_str1.is_integer?)
          client.emit_failure t('wod20skills.numbers_only_for_npc_skills')
          return
        end
        ...
        die_result1 = WOD20Skills.parse_and_roll(model1, self.roll_str1)
        die_result2 = WOD20Skills.parse_and_roll(model2, self.roll_str2)
        ...
        results = WOD20Skills.opposed_result_title(self.name1, successes1, self.name2, successes2)

        message = t('wod20skills.opposed_roll_result',
           :name1 => !model1 ? t('wod20skills.npc', :name => self.name1) : model1.name,
           :name2 => !model2 ? t('wod20skills.npc', :name => self.name2) : model2.name,
